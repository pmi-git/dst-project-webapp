...
docker-compose -f compose/docker-compose.base.yml down -v

echo "Reconstruction complète des images..."
docker-compose -f compose/docker-compose.base.yml build --no-cache

echo "Lancement des conteneurs en arrière-plan..."
docker-compose -f compose/docker-compose.base.yml up -d
